...
video_id: WMiylHobhBM
url: https://www.youtube.com/watch?v=WMiylHobhBM
published: 2026-07-15T18:43:18+00:00
generated: 2026-07-15T19:34:06+00:00
model: "z-ai/glm-5.2"
thumbnail: https://i.ytimg.com/vi/WMiylHobhBM/hqdefault.jpg
---
# AI NEWS LIVE

[![AI NEWS LIVE](https://i.ytimg.com/vi/WMiylHobhBM/hqdefault.jpg)](https://www.youtube.com/watch?v=WMiylHobhBM)

[Watch on YouTube](https://www.youtube.com/watch?v=WMiylHobhBM) · **Matthew Berman** · 2026-07-15

## TL;DR
This video is a live AI news discussion featuring Matthew Berman and the "Future team." The brief available transcript captures only the opening moments, covering technical setup, casual banter, and the introduction of the first topic: OpenAI's first hardware device.

## Key Takeaways
- The video is a live-streamed AI news discussion, not a scripted or edited video.
- Matthew Berman is joined by a team referred to as the "Future team," including someone named Alex.
- The stream begins with informal pre-show-style chatter about audio, video, and viewer count.
- The hosts use eCamm for live-stream production.
- The first announced topic of discussion is OpenAI's first hardware device.
...
## Notable Quotes
- "We are live, yeah."
- "Well, it might be us three."
- "No, no, no, no. There's people pouring in."
- "We're live with the full Future team."
- "We have the first hardware device from OpenAI."

## People, Tools & References Mentioned
- **Matthew Berman** — Host/channel owner.
- **Alex** — Mentioned as a likely participant.
- **Future team** — The group joining Matthew for the discussion.
- **eCamm** — Live-streaming production software referenced for viewer count.
- **OpenAI** — Mentioned in relation to their first hardware device.
