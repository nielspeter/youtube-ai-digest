...
channel: "OpenAI"
video_id: jaYDbeQTUR0
url: https://www.youtube.com/watch?v=jaYDbeQTUR0
published: 2026-07-16T15:37:08+00:00
generated: 2026-07-16T17:43:37+00:00
model: "z-ai/glm-5.2"
thumbnail: https://i.ytimg.com/vi/jaYDbeQTUR0/hqdefault.jpg
---
# Have a Crazy Idea? Build It with Codex | Romain Huet | OpenAI France

[![Have a Crazy Idea? Build It with Codex | Romain Huet | OpenAI France](https://i.ytimg.com/vi/jaYDbeQTUR0/hqdefault.jpg)](https://www.youtube.com/watch?v=jaYDbeQTUR0)

[Watch on YouTube](https://www.youtube.com/watch?v=jaYDbeQTUR0) · **OpenAI** · 2026-07-16

## TL;DR
Romain Huet of OpenAI France encourages builders to bring their long-shelved "crazy ideas" to life using AI. He highlights the vibrant energy of the Paris tech scene and urges founders to be more ambitious and curious with AI models, which are already remarkably capable.

## Key Takeaways
- Bring your passion projects and "crazy ideas" to AI models like Codex—you'll be surprised by the results.
- The Paris tech scene has an incredible, vibrant energy with a lot of active building happening.
- AI models are already very smart—in many ways smarter than us—yet people are still too shy or conservative in how they use them.
- Models want to hear more from users; be more expressive and demanding in your prompts.
- Founders are actively building companies using OpenAI's models.
- The best advice for builders is simply to be curious and try the things you've always wanted to try.
- OpenAI ships new models roughly every 6 weeks, and users adapt so quickly that they're already eager for the next release.
...
## Notable Quotes
- "Ask your best crazy ideas, the passion projects you've been putting on the side for way too long. Give them to Codex and you'll be surprised."
- "The biggest takeaway is really the energy. There's so much going on in Paris in this tech scene."
- "Those models are already so so smart. In many ways they're smarter than us, but we're still too shy with them."
- "We ship models every 6 weeks and yet we get so used to them after like just a few days that we're kind of like already eager to see what's next."

## People, Tools & References Mentioned
- **Romain Huet** — OpenAI France
- **Codex** — OpenAI's AI coding tool (referred to as "Kodak" in the transcript, likely a transcription error)
- **OpenAI** — The company shipping the AI models discussed
- **Paris tech scene** — Highlighted for its vibrant energy and active builder community
